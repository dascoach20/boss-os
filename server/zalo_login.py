"""
Đăng nhập Zalo bằng QR ngay trong UI Boss OS (connector "zalo" - zalo-agent-cli).
...
def start(label=None):
    ...
    argv = _npx_argv()
    if not argv:
        return {"ok": False, "error": "Cần cài Node.js 20+ (lệnh npx) trên máy chạy Boss OS - tải tại nodejs.org"}
